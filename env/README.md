...
`python pretrain.py --config ./configs/fovea.json --env dm2s-v0 --env-config ./configs/dm2s_env.par --env-data-file=./data/gen --env-obs-key=fovea --model-file=./data/gen/fovea.pt --epochs 100`
